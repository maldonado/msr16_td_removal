...
\begin{table}[t]
	\centering
	\caption{\textsc{Number of the survey responses per project.}}
	...
	\begin{tabular}{@{}p{0.9cm}p{0.7cm}p{0.7cm}p{0.7cm}p{0.7cm}p{0.7cm}p{0.7cm}p{0.7cm}@{}}
		...
		\textbf{\#Sent Emails} & 50 & 31 & 58 & 10 & 17 & 71 & 13  \\ \midrule
...
While participants have been purposefully recruited, we did not store any identifying information  about the individual respondents.~\alexander{AS: 1) please provide the link to the survey form; 2) are we sure that developers could not be identified based on the project/addd or removed SATD? Can we report the number of such developers per project? 3) any other ethical risks?}

...
%~\alexander{AS: 1) please provide the link to the survey form; 2) are we sure that developers could not be identified based on the project/addd or removed SATD? Can we report the number of such developers per project? 3) any other ethical risks?}

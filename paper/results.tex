...
In addition we compare the two distributions using a Mann-Whitney test~\cite{} \todo{add citation} to determine if the difference is statistically significant at $p$ $<$$=$ 0.05. We also estimated the magnitude of the difference between self-removed technical debt and non self-removed technical debt using the Cliff's Delta (or $d$), a
non-parametric effect size measure~\cite{} \todo{add citation} for ordinal data. We consider the effect size values: small for $d$ $<$ 0.33 (positive as well as negative values), medium for 0.33  $\leq d<$ 0.474 and large for $d \geq$ 0.474.



\noindent \textbf{Results:} \emad{we need to add the general result of how long SATD lives in a project period.}

 We find that self-removed technical debt gets removed faster than non self-removed technical debt. Figures \ref{fig:removal_comparison_gerrit}, \ref{fig:removal_comparison_hadoop} and \ref{fig:removal_comparison_tomcat} presents the comparison between self-removal and non self-removal of three projects, namely, Gerrit, Hadoop and Tomcat. We selected these projects as they represent the general behavior of the analyzed dataset. As we can observe in Figures \ref{fig:removal_comparison_gerrit}, \ref{fig:removal_comparison_hadoop} and \ref{fig:removal_comparison_tomcat} self-removal technical debt is removed faster then non self-removal technical debt when considering the amount of days that each technical debt was part of the analyzed system. The horizontal black line on each figure mark the median of the dataset, that also happens earlier for self-removed technical debt. In addition for each figure we plotted the number of occurrences measured on each dataset on the legend indicated by the letter `N'' followed by the precise median in days.
...
To address this research question, we analyze the developer responses to the online survey described in section~\ref{Survey_Design}. The survey has two main section related the self-admitted technical debt. First, likert scale type of questions about how often developers encounter, add and address technical debt comments. Second, two open-ended questions about the activities that developers perform to add and address self-admitted technical debt. For, the open-ended questions, we manually analysis the answers (in free text), and we identified 6 reasons why developers add self-admitted technical debt and 5 reasons for removing self-admitted technical debt.

\noindent \textbf{Results:} 
Figure~\ref{fig:encouner_add_address} shows the results of the likert scale questions about how often developers encounter, add, address self-admitted technical debt. Developers mostly agreed that they encounter source code comments indicting self-admitted technical debt. 50\% of the developers stated that they sometimes see such comments, and the other 50\% of them said they encounter such comments often. For adding self-admitted technical debt, developers responses vary from they often add self-admitted technical debt (around 21\%) to rarely (around 36\%). Other 43\% said that they sometimes added such comments. we also asked developers how often they address self-admitted technical debt. The highest agreed response is that developers interestingly rarely (50\%) address self-admitted technical debt. 29\% of respondents also agreed that they sometimes address self-admitted technical debt. Only 21\% of the respondents agreed that they often address self-admitted technical debt.

Approximately 64\% of developers (P1, P4, P5, P8, P9, P11, P12, P13, and P14) indicted that they add self-admitted technical debt as a tracker in the source code for potential bug or source code that needs to be improved or development new feature. For example, P12 stated \textit{"It is usually a marker in the source of a missing feature or known bug."}. We also found that developers add self-admitted technical debt because of time pressure (around 36\% - P1, P2, P7, P13, and P14) to deliver tasks. For example, P1 \textit{"Because they want to deliver, and when balancing an early delivery against technical debt."} Some other reasons for adding self-admitted technical debt are very small and mentioned ones or twice (e.g,. remainder or looking for feedback). For example, P5 said that \textit{"They are not sure about the effects of their code and want feedback..."}.

In responses to the question why do developers address self-admitted technical debt, we identified five reasons. The most cited reasons for addressing self-admitted technical debt is when developers fix bugs (around 64\% - P1, P4, P5, P7, P8, P9, P10, P12 and P13). For example, P12 said \textit{", usually as part of fixing a user-reported issue..."} The second most reasons for addressing self-admitted technical debt are adding new feature (36\% - P1, P4, P6, P12, and P14) and improving the code (36\% - P7, P8, P9, P10, and P11). The other two reasons are less common which are refactoring (14\% - P7 and P9) and better solution (14\% - P2 and P7). 



 \conclusion{Developer mostly add self-admitted technical debt }
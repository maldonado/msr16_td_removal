...
\begin{table*}[t]
	...
	\end{center}    
\end{table*}
\conclusion{We find that the majority of \SATD comments are removed over time. In our five case study projects, between 40.5 - 90.6\% (average 74.9\%) of the identified \SATD is removed.}

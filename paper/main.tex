...
% research questions 
\newcommand{\rqi}{\textbf{RQ1. How much of self-admitted technical debt gets removed ?\\}}
\newcommand{\rqii}{\textbf{RQ2. How long does it take to remove technical debt in case of self-removal?\\}}
\newcommand{\rqiii}{\textbf{RQ3. Is there difference in self-removal rate/speed between different kinds of technical debt?\\}}
% \newcommand{\rqiv}{\textbf{RQ4. Why these TD's are removed and why some of them does not get removed ?\\}}

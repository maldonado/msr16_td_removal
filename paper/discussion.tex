...
\alexander{It seems that the following is the only reference on comment removal and this is not comparable with our results. Shall we keep it or drop it? Move it elsewhere?}

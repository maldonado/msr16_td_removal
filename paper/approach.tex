...
%We parse the source code in order to extract the source code comments. 
...
As the prior work showed, not all comments can contain \SATD \cite{Potdar2014ICSME,Wehaibi2016SANER}. Therefore,  as the pre-processing we exclude the following types of comments:% from our dataset: %before applying the NLP-based classification to determine \SATD comments:

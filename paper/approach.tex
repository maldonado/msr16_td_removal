...
As the prior work showed, not all comments can contain \SATD \todo{add cite}. Therefore,  as the pre-processing we remove the following types of comments from our dataset: %before applying the NLP-based classification to determine \SATD comments:
...
\item \textbf{Commented source code} is also ignored since prior work showed that it generally does not contain \SATD \todo{cite}.
...
\item \textbf{Javadoc comments} are also removed since they rarely mention self-admitted technical debt \todo{cite}. 

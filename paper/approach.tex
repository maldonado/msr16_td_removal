...
\begin{table*}[thb!]
    ...
    \label{tab:project_details}
            ...
            & \textbf{\thead{\# of Java files}} & \textbf{\thead{SLOC}} & \textbf{\thead{\# of file\\versions}} & \textbf{\thead{\# of \\contributors}}  & \textbf{\thead{\# of \\comments}}   & \textbf{\thead{\# of \\comments \\after filtering}} & \textbf{\thead{\# of \\TD \\comments}}  & \textbf{\thead{\# of \\unique TD \\comments}}\\ 
            \midrule 
...
\noindent\textbf{Filtering Irrelevant Comments.} As the prior work showed, not all comments can contain \SATD \todo{add cite}. Therefore, we remove the following types of comments from our dataset before applying the NLP-based classification to determine \SATD comments:

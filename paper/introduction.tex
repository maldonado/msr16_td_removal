...
Our empirical findings provide insights to developers and software projects on how to best manage \SATD. For example, our findings show that most \SATD is self-removed, providing insight on who typically removes \SATD in large open source projects. To ease replication, we make all the data used in our study  and the online survey questions available online~\footnote{\url{http://das.encs.concordia.ca/uploads/2017/07/maldonado_icsme2017.zip}}.

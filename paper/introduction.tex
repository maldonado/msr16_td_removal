...
\rabe{These finding highlight that self-admitted technical debt indicated in the source code comment are important development practice. So, developers go back and remove them...!  }

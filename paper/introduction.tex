...
\end{itemize}
To answer those questions, we first devise a technique to determine SATD introduction and removal. In total, we examine \todo{add number} instances of SATD removals.

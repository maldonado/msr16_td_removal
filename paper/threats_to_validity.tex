\rabe{In this section, we discuss the threats to validity of our study, following
	common guidelines for empirical studies~\cite{yin2013case}.}


\noindent~\emph{\textit{Internal Validity:}} \rabe{Internal validity concerns with factors that could
...
\noindent~\emph{\textit{Construct Validity:}} \rabe{Threats to constructed validity concern the relationship between theory and observation.}
...
\noindent~\emph{\textit{External Validity:}} \rabe{Threats to external validity concern the generalization of our findings.} Our study is conducted on five large open source projects and contains more than 5,700 comment removals. That said, our findings may not generalize to other open source or commercial systems.